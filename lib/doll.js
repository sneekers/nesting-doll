...
Doll.prototype.activate = function () {
  this._active = true;
};

Doll.prototype.deactivate = function () {
  this._active = false;
};
...
Doll.prototype.rawBind = function (callback, context) {
  return this.namespace.bind(
    callback,
    context || this.namespace.createContext()
  );
...
Doll.prototype._wrapCallback = function (callback) {
  ...
  function wrappedCallback() {
    ...
    if (previous && previous._active) {
      self._previous = previous;
    } else if (self._outer) {
      self._previous = outer;
    }
